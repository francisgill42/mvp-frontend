<template>
<div class="mb-15">
<h2 class="mt-5 primary white--text pa-1 mb-2 text-center ">Best Seller Products</h2>  
<v-row>
...
<v-btn class="primary" small  dark>Buy Now</v-btn>
<v-btn class="primary"  @click="addItemToCart" small dark>add to cart</v-btn>
</v-card-text>
</v-card>
</v-hover>
</v-col>
